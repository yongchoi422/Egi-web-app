  ...
  <div class="page">
    <div class="page__header">
      <TextWrapper :max-symbols="102" class="page__description">
        Egi, $EGi. The ERC-20i with Native Inscriptions./n/n
        $EGi is a unique, fully on-chain art project offering an innovative new ERC-20i format with inscription metadata. Each portion of tokens resembles a seed that generates unique 24x24 dynamic images of Egi stored on-chain, depending on the wallet's token balance./n/n
